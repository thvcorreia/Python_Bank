...
from utils.helper import date_para_srt, str_para_date
...
class Cliente:
    ...
    def __init__(self: object, nome: str, email: str, cpf: str, data_nascimento: str) -> None:
        ...
        self.__cpf: str = cpf
        self.__data_nascimento: str = str_para_date(data_nascimento)
    ...
    def data_nascimento(self: object) -> str:
        return date_para_srt(self.__data_nascimento)

    @property
    def data_cadastro(self: object) -> str:
        return date_para_srt(self.__data_cadastro)
